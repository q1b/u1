 ...
 */
const SERVERS = {
  "POST /api/push/send": `/api/push/send`,
  "POST /api/push/subscribe": `/api/push/subscribe`,
  "POST /api/push/unsubsribe": `/api/push/unsubsribe`,
...
export type KIT_ROUTES = {
  PAGES: { '/': never, '/app': never, '/app/settings': never }
  SERVERS: { 'POST /api/push/send': never, 'POST /api/push/subscribe': never, 'POST /api/push/unsubsribe': never, 'GET /login/google': never, 'GET /login/google/callback': never }
  ACTIONS: { 'default /app': never }
  LINKS: { 'github': never }
