...
<main class="w-full max-w-2xl p-4 relative">
	...
	<button class="cursor-pointer p-2 rounded-full bg-fuchsia-300 hover:scale-95" aria-label="goto messages">
		<MessagesSquare />
	</button>
	<a class="p-2 rounded-full bg-fuchsia-300 hover:scale-95" href="app/settings" aria-label="goto app settings">
		<Settings />
	</a>
	<button
